...
**Status:** NOT STARTED · **Target:** 2026-09-18
...
|---|---|---|---|
| Persistence foundation | `azj` | db open/migrate/test db, tasks table, domain layer, guard test, persistence + data-model docs | |
