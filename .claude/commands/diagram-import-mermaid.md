...
Redraw the Mermaid source at `$1` in this skill's design system, following `.claude/skills/diagram-design/references/import-mermaid.md` and `.claude/skills/diagram-design/references/output-spec.md`. Treat those references as the source of truth.
...
- Type is chosen from the extracted grammar and structure; `--type` forces one of the visual
  types in `.claude/skills/diagram-design/SKILL.md` §3.
...
2. **Run `python3 .claude/skills/diagram-design/scripts/mermaid_extract.py` first** (the skill is vendored in this repo).
