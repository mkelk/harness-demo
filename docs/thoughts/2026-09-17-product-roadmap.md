...
| 02        | Organise    | Give tasks a due date and a priority, group them into lists, and find them by filter and search | (1) Due dates and priority. (2) Lists and filtering.                                                                           | shipped 2026-09-17 as 02-ngm, spec `2026-09-17-increment-02-organise.md`    |
