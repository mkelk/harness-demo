...
| --------- | ----------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ |
| 01        | Task basics | Keep a persistent list of tasks: add, see, complete, reopen, edit, delete                       | (1) Persistence foundation: SQLite, migrations, `tasks` table, repository, test db. (2) Task list: pages, server actions, e2e. | planned, spec `2026-09-17-increment-01-task-basics.md` |
