...
**Last documentation update:** 2026-09-17 (epic Lists and filtering, tick 3e9: how/lists added with the `lists-and-filters` diagram, tasks and scheduling updated for `TaskPage` and `basePath`).
