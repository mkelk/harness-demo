...
**Last documentation update:** 2026-09-17 (epic Lists and filtering closed: how/lists added and rendered, data-model and task-flow re-rendered, tasks and README updated).
