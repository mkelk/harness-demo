...
- Warm/cold ratio, epic 1 and 2 data: cold dispatches 3.5 / 3.3 / 1.4 min per tick; a 3-tick warm-chain 9.9 min (3.3 min per tick). No measurable saving at this tick size; chains still pay off by avoiding seam-file merges. Heuristic: ticks here are ≲20 min and
